...
// Thread-local secp256k1 context for signing
thread_local! {
...
pub fn sign_message(
    ...
    SECP256K1_CTX.with(|ctx| {
        ...
        // EIP-155 style recovery id (27 or 28)
...
mod tests {
    ...
    fn test_key_generation_and_derivation() {
        ...
        // Address should be 20 bytes, represented as 42-char hex string
