...
impl NetworkConfig {
    pub const OFFICIAL_BOOTSTRAP_NODES: &'static [&'static str] = &[
        ...
        "/dns4/boot1.nonos.systems/tcp/9432/p2p/12D3KooWAHtxSqGkTbpYjmJW55BpScGkezkWF3sQBK7Pv3CHjTPE",  /// I HAVE TO ADD AND RECREATE NEW ID AFTER CHANGE
    ];                                                                                                  /// We will have a total of 5 BOOTSTRAP_NODES and start w/ 2 nonos_nodes
