...
//! NONOS Daemon - Decentralized node powering the NONOS browser
//!
//! # Commands
//!
//! Staking & Rewards:
//!   nonos stake status                # Show staking info
//!   nonos stake deposit <amount>      # Stake NOX tokens
//!   nonos rewards claim               # Claim pending rewards
//!
//! Configuration:
//!   Default config: ~/.nonos/config.toml
//!   Environment variables:
//!     NONOS_DATA_DIR       - Data directory path
//!     NONOS_API_PORT       - API server port (default: 8420)
//!     NONOS_RPC_URL        - Ethereum RPC endpoint
//!     NONOS_WALLET_KEY     - Wallet private key for signing
//!     NONOS_LOG_LEVEL      - Log level (trace, debug, info, warn, error)
