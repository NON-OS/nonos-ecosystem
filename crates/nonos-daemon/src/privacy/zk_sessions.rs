...
//! ZK-Authenticated Session Management
//!
//! Provides zero-knowledge proof based session authentication:
//! - Groth16 proof generation for identity
//! - Session commitment with nullifier tracking
