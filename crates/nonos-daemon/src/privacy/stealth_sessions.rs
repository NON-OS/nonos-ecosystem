...
//!
//! Provides anonymous browsing session management:
//! - Stealth address generation for session isolation
//! - Ephemeral keypair per session
//! - Domain visit tracking with privacy
//! - Secure session cleanup on drop
