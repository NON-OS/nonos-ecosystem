...
echo "  2. Clone repo: git clone https://github.com/NON-OS/nonos-ecosystem.git"
echo "  3. Build: cd nonos-ecosystem && cargo build --release -p nonos-daemon"
echo "  4. Install: sudo cp target/release/nonos-daemon /usr/local/bin/"
echo "  5. Run: nonos-daemon run"
echo ""
